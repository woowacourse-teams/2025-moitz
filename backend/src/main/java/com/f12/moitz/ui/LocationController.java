                        ...
                        new RecommendationResponse(1L, 1, 37.54040751726388, 127.06920291650829, "건대입구역", 18, true,
                                ...
                                List.of(
                                        ...
                                        new RouteResponse(2, 1, 18, List.of(
                                                ...
                                                new PathResponse(3, "동대문역사문화공원", 127.007821, 37.565147,
                                                        "건대입구", 127.06920291650829, 37.54040751726388, "2호선", 13)
                                        )),
                                        new RouteResponse(3, 0, 33, List.of(
                                                new PathResponse(1, "서울대입구", 126.952713197762, 37.4812845080678,
                                                        "건대입구", 127.06920291650829, 37.54040751726388, "2호선", 33)
                                        ))
                                )
                        ),
                        new RecommendationResponse(2L, 2, 37.47656223234824, 126.98155858357366, "사당역", 18, true,
                                ...
                                List.of(
                                        new RouteResponse(1, 0, 25, List.of(
                                                new PathResponse(1, "강변", 127.094741101863, 37.5351180385975,
                                                        "사당", 126.98155858357366, 37.47656223234824, "2호선", 25)
                                        )),
                                        new RouteResponse(2, 0, 25, List.of(
                                                new PathResponse(1, "동대문", 127.01063381083677, 37.571669405802616,
                                                        "사당", 126.98155858357366, 37.47656223234824, "4호선", 25)
                                        )),
                                        new RouteResponse(3, 0, 4, List.of(
                                                new PathResponse(1, "서울대입구", 126.952713197762, 37.4812845080678,
                                                        "사당", 126.98155858357366, 37.47656223234824, "2호선", 4)
                                        ))
                                )
                        ),
                        new RecommendationResponse(3L, 3, 37.561268363317176, 127.03710337610202, "왕십리역", 18, true,
                                ...
                                List.of(
                                        new RouteResponse(1, 0, 11, List.of(
                                                new PathResponse(1, "강변", 127.094741101863, 37.5351180385975,
                                                        "왕십리", 127.03710337610202, 37.561268363317176, "2호선", 11)
                                        )),
                                        new RouteResponse(2, 1, 11, List.of(
                                                ...
                                                new PathResponse(2, "동대문역사문화공원", 127.007821, 37.565147,
                                                        "동대문역사문화공원", 127.007821, 37.565147, null, 3),
                                                new PathResponse(3, "동대문역사문화공원", 127.007821, 37.565147,
                                                        "왕십리", 127.03710337610202, 37.561268363317176, "2호선", 6)
                                        )),
                                        new RouteResponse(3, 1, 32, List.of(
                                                new PathResponse(1, "서울대입구", 126.952713197762, 37.4812845080678,
                                                        "선릉", 127.049271, 37.504577, "2호선", 16),
                                                new PathResponse(2, "선릉", 127.049271, 37.504577,
                                                        "선릉", 127.049271, 37.504577, null, 3),
                                                new PathResponse(3, "선릉", 127.049271, 37.504577,
                                                        "왕십리", 127.03710337610202, 37.561268363317176, "수인분당선", 13)
                                        ))
                                )
                        ),
                        new RecommendationResponse(4L, 4, 37.570227990912244, 126.98315081716676, "종각역", 24, false,
                                ...
                                List.of(
                                        new RouteResponse(1, 2, 32, List.of(
                                                new PathResponse(1, "강변", 127.094741101863, 37.5351180385975,
                                                        "을지로3가", 126.991041, 37.566285, "2호선", 19),
                                                new PathResponse(2, "을지로3가", 126.991041, 37.566285,
                                                        "을지로3가", 126.991041, 37.566285, null, 3),
                                                new PathResponse(3, "을지로3가", 126.991041, 37.566285,
                                                        "종로3가", 126.991841, 37.571653, "3호선", 4),
                                                new PathResponse(4, "종로3가", 126.991841, 37.571653,
                                                        "종로3가", 126.991841, 37.571653, null, 3),
                                                new PathResponse(5, "종로3가", 126.991841, 37.571653,
                                                        "종각", 126.98315081716676, 37.570227990912244, "1호선", 3)
                                        )),
                                        new RouteResponse(2, 0, 5, List.of(
                                                new PathResponse(1, "동대문", 127.01063381083677, 37.571669405802616,
                                                        "종각", 126.98315081716676, 37.570227990912244, "1호선", 5)
                                        )),
                                        new RouteResponse(3, 2, 36, List.of(
                                                new PathResponse(1, "서울대입구", 126.952713197762, 37.4812845080678,
                                                        "사당", 126.98155858357366, 37.47656223234824, "2호선", 4),
                                                new PathResponse(2, "사당", 126.98155858357366, 37.47656223234824,
                                                        "사당", 126.98155858357366, 37.47656223234824, null, 3),
                                                new PathResponse(3, "사당", 126.98155858357366, 37.47656223234824,
                                                        "서울역", 126.972709, 37.553512, "4호선", 18),
                                                new PathResponse(4, "서울역", 126.972709, 37.553512,
                                                        "서울역", 126.972709, 37.553512, null, 3),
                                                new PathResponse(5, "서울역", 126.972709, 37.553512,
                                                        "종각", 126.98315081716676, 37.570227990912244, "1호선", 8)
                                        ))
                                )
                        ),
